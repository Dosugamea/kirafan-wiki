...
Vue.prototype.$asset = {
  ...
  advlibraryicon: 'https://asset.kirafan.cn/texture/advlibraryicon/advlibraryicon_{0}',
  ...
  battleuiatlas: 'https://asset.kirafan.cn/uiatlas/battleuiatlas.muast?name={0}',
  characard: 'https://asset.kirafan.cn/texture/charauiresource/characard/characard_{0}',
  charaicon: 'https://asset.kirafan.cn/texture/charauiresource/charaicon/charaicon_{0}',
  charaillustchara: 'https://asset.kirafan.cn/texture/charauiresource/charaillustchara/charaillust_chara_{0}',
  charaillustfull: 'https://asset.kirafan.cn/texture/charauiresource/charaillustfull/charaillust_full_{0}',
  commonuiatlas: 'https://asset.kirafan.cn/uiatlas/commonuiatlas.muast?name={0}',
  contentslogo: 'https://asset.kirafan.cn/texture/contenttitlelogo/contentslogo{0}',
  ...
  ordericon: 'https://asset.kirafan.cn/texture/charauiresource/ordericon/en_ordericon_{0}',
  originalcharacterillust: 'https://asset.kirafan.cn/texture/originalcharacterillust/originalcharacterillust_{0}',
  originalcharactericon: 'https://asset.kirafan.cn/texture/originalcharactericon/originalcharactericon_{0}',
  roomobjecticon: 'https://asset.kirafan.cn/texture/roomobjecticon/roomobjecticon_{_0}_{1}',
  /* TODO: index */ standpic: 'https://asset.kirafan.cn/adv/standpic/{0}/{1}',
  townobjecticon: 'https://asset.kirafan.cn/texture/townobjecticon/townobjecticon_bld_{1}',
...
Vue.prototype.$version = 'Forked-version-0.0.1 Media 4.1.3';
