...
//   );
//   console.log(
//     `\tawb2hcas [-d] [-k <key>] [-t <type>] [-o <outputDir>] [-s] <awbPath>...`
//   );
//   console.log(
//     `\tawb2wavs [-k <key>] [-o <outputDir>] [-v <volume>] [-m <mode>] [-s] <awbPath>...`
//   );
//   console.log(
//     `\thca2wav [-k <key>] [-w <awbKey>] [-o <outputFile>] [-v <volume>] [-m <mode>] <hcaPath>...`
//   );
...
//           await acb.acb2hcas(pathes[i], key, output, type, skip);
//         break;
//       case "acb2wavs":
//         await handlePathes(pathes, ".acb");
//         for (let i = 0; i < pathes.length; i++)
//           await acb.acb2wavs(pathes[i], key, output, volume, mode, skip);
//         break;
//       case "awb2hcas":
//         if (!decrypt) key = undefined;
//         await handlePathes(pathes, ".awb");
//         for (let i = 0; i < pathes.length; i++)
//           await afs2.awb2hcas(pathes[i], key, output, type, skip);
//         break;
//       case "awb2wavs":
//         await handlePathes(pathes, ".awb");
//         for (let i = 0; i < pathes.length; i++)
//           await afs2.awb2wavs(pathes[i], key, output, volume, mode, skip);
//         break;
//       case "hca2wav":
...
//         for (let i = 0; i < pathes.length; i++)
//           await utf.viewUtf(pathes[i], output);
//         break;
//       // case "decrypt_acb":
//       //   await handlePathes(pathes, ".acb");
//       //   for (let i = 0; i < pathes.length; i++)
//       //     await acb.decryptAcb(pathes[i], key, type);
//       //   break;
//       case "decrypt_awb":
//         await handlePathes(pathes, ".awb");
//         for (let i = 0; i < pathes.length; i++)
//           await afs2.decryptAwb(pathes[i], key, type);
//         break;
//       case "decrypt_hca":
//         await handlePathes(pathes, ".hca");
//         for (let i = 0; i < pathes.length; i++)
//           await hca.decryptHca(pathes[i], key, awbKey, type, pathes[i]);
//         break;
//       case "acb_mix":
//         await handlePathes(pathes, ".acb");
//         for (let i = 0; i < pathes.length; i++)
//           await acb.mixAcb(pathes[i], key, output, mode, skip);
//         break;
//       case "extract_cpk":
//         await handlePathes(pathes, ".cpk");
//         for (let i = 0; i < pathes.length; i++)
//           await cpk.extractCpk(pathes[i], output);
//         break;
//       default:
//         usage();
//         break;
